...
class CharManFitterQueryRepr1(MultiLevelAttentionCompositeFitter):
    ...
    def _get_multiple_evidences_predictions_normal(self,
        ...
        # for evd_cnt, evd_doc_cont, evd_adj, evd_trans  in zip(evd_count_per_query, evd_doc_contents, evd_docs_adj, evd_docs_emb_transformer):
        for evd_cnt, evd_doc_cont, evd_adj  in zip(evd_count_per_query, evd_doc_contents, evd_docs_adj):
            ...
            # e_emb_transformer.append(evd_trans[:evd_cnt])
